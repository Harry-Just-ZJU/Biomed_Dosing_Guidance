...
<head>
  ...
  <style>
    ...
    .role-btn { flex:1; padding:.6rem; border:1.5px solid var(--border);
      ...
      transition:var(--transition); background:rgba(139,92,246,.04); }
    .role-btn.selected { border-color:var(--purple-mid); color:var(--purple-light);
...
<div class="auth-wrap pm-animate">
  <div class="auth-logo">
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" style="vertical-align:middle;margin-right:8px;">
      <circle cx="12" cy="12" r="3" fill="url(#rg)"/>
      <circle cx="12" cy="12" r="7" stroke="url(#rg)" stroke-width="1.5" fill="none" opacity=".5"/>
      <circle cx="12" cy="12" r="11" stroke="url(#rg)" stroke-width="1" fill="none" opacity=".25"/>
      <defs>
  ...
  <div class="auth-card">
    ...
    <p style="text-align:center;margin-top:1.5rem;font-size:.85rem;color:var(--muted);">
      ...
      <a href="<%=request.getContextPath()%>/login"
         style="color:var(--purple-light);font-weight:600;">Sign in</a>
    </p>
  </div>
</div>
